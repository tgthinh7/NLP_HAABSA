...
with open(str(FLAGS.hardcoded_path) + '/data/programGeneratedData/768hypertraindata2015.txt', 'w') as filehandle:
    for listitem in train:
        filehandle.write('%s\n' % listitem)
with open(str(FLAGS.hardcoded_path) + '/data/programGeneratedData/768hyperevaldata2015.txt', 'w') as filehandle:
    for listitem in val:
        filehandle.write('%s\n' % listitem)